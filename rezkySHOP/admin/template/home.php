...
<div class="row">
    ...
    <div class="col-md-3 mb-3">
        <div class="card">
            <div class="card-header text-white" style="background:navy">
            ...
            <div class="card-footer">
                <a href='index.php?page=barang' style="color:navy">Tabel
    ...
    <div class="col-md-3 mb-3">
        <div class="card">
            ...
            <div class="card-footer">
                <a href='index.php?page=barang' style="color:black">Tabel
                    Barang <i class='fa fa-angle-double-right'></i></a>
            </div>
        </div>
        <!--/grey-card -->
    ...
    <div class="col-md-3 mb-3">
        <div class="card">
            ...
            <div class="card-footer">
                <a href='index.php?page=laporan' style="color:navy">Tabel
    ...
    <div class="col-md-3 mb-3">
        <div class="card">
            ...
            <div class="card-footer">
                <a href='index.php?page=kategori' style="color:black">Tabel
